    ...
    return (
        <div id='contact' className='flex flex-col justify-center items-center'>
            ...
            <form action="https://formsubmit.co/jessica.swenson.dev@gmail.com" method="POST" className='flex flex-col items-center'>
                ...
                <input className='rounded border border-black p-3 m-5' name='name' type="text" placeholder='Name (required)' required />
                <input name='phoneNumber' className='rounded border border-black p-3 mb-5' type="text" placeholder='Phone Number (required)' minLength={10} required />
                <input name='email' className='rounded border border-black p-3 mb-5' type="email" placeholder='Email (required)' required />
