...
const Banner = () => {
    return (
        <div id='home' className='flex flex-col items-center text-center md:mt-20'>
            ...
            <button className="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 border border-red-700 rounded h-auto md:text-xl md:mb-60">Get a Quote</button>
        </div>
    )
}
